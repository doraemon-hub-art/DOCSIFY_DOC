...
(实际上就是在Nvim基础上，导入AstroNVimd的自定义配置)
...
AstroNVim社区中提供了很多直接插件，我们可以直接拿过来用。
...
很重要的一点，为了更好的切换模式和取消某些操作，把没啥用的大写锁定键改成ESC，会更加舒服。
...
在后面的内容中，我会进一步研究AstroNVim的配置，并与你分享。
