...
在本文中，我们从WebRTC概念出发，并简单介绍一些相关名词，到最后简单的的商业集成服务AWS KVS介绍，做一个一站式的串联讲解，如果你准备要接触一下WebRTC，那么我想这会对你有一些帮助。
而本期内容的重点，更多在应用上。
...
> 名字中带有Web，在设计之初只是应用于Web场景吗？



> 那么在WebRTC出来之前，人们用什么协议传输视频流呢 ？
...
https://github.com/paullouisageneau/libdatachannel/tree/master
